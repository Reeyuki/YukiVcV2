...
var P = (a, e, t) =>
  ...
  D = (a, e) => {
    ...
    if (T) for (var t of T(e)) R.call(e, t) && P(a, t, e[t]);
    return a;
  },
  A = (a, e) => k(a, _(e));
...
var w = ((a) => ((a.up = "up"), (a.down = "down"), (a.left = "left"), (a.right = "right"), a))(w || {}),
  ...
  F = ((a) => (
    ...
    (a[(a.X = 2)] = "X"),
    (a[(a.Y = 3)] = "Y"),
    (a[(a.LShoulder = 4)] = "LShoulder"),
    (a[(a.RShoulder = 5)] = "RShoulder"),
    (a[(a.LTrigger = 6)] = "LTrigger"),
    (a[(a.RTrigger = 7)] = "RTrigger"),
    (a[(a.Back = 8)] = "Back"),
    (a[(a.Start = 9)] = "Start"),
    (a[(a.LStick = 10)] = "LStick"),
    (a[(a.RStick = 11)] = "RStick"),
    (a[(a.DPadUp = 12)] = "DPadUp"),
    (a[(a.DPadDown = 13)] = "DPadDown"),
    (a[(a.DPadLeft = 14)] = "DPadLeft"),
    (a[(a.DPadRight = 15)] = "DPadRight"),
    (a[(a.Vendor = 16)] = "Vendor"),
    a
  ))(F || {}),
  j = ((a) => (
    (a[(a.LStickX = 0)] = "LStickX"),
    (a[(a.LStickY = 1)] = "LStickY"),
    (a[(a.RStickX = 2)] = "RStickX"),
    (a[(a.RStickY = 3)] = "RStickY"),
    a
  ))(j || {}),
  S = ((a) => (
    (a.TapTarget = "gpad-tap-target"),
    (a.ButtonIcon = "gpad-btn-icon"),
    (a.ButtonShadow = "gpad-shadow"),
    (a.ButtonHighlight = "gpad-highlight"),
    (a.ButtonBackground = "gpad-btn-bg"),
    (a.DirectionHighlight = "gpad-direction-highlight"),
    (a.Thumbstick = "gpad-thumbstick"),
    (a.GpadBaseShape = "gpad-base"),
    (a.StickBaseShape = "gpad-stick-base"),
    a
  ))(S || {});
const B = [
    "button_1",
...
class q {
  constructor(e) {
    ...
    p(this, "_getGamepads");
    ((this.updateDelay = e.updateDelay || 0),
      (this.axisDeadZone = e.axisDeadZone || 0),
      (this.buttonConfigs = e.buttonConfigs || []),
      ...
      (this._getGamepads =
        navigator.getGamepads || navigator.webkitGetGamepads || navigator.mozGetGamepads || navigator.msGetGamepads),
      (this.gamepadApiSupported() || navigator.getNativeGamepads !== void 0) && this.tickLoop());
  }
  setButtonsConfig(e) {
  ...
  offGamepadConnect(e) {
    ((this.gamepadConnectListeners = this.gamepadConnectListeners.filter((t) => t !== e)),
      window.removeEventListener("gamepadconnected", e, !0));
  }
  ...
  offGamepadDisconnect(e) {
    ((this.gamepadDisconnectListeners = this.gamepadDisconnectListeners.filter((t) => t !== e)),
      window.removeEventListener("gamepaddisconnected", e, !0));
  }
  ...
  cleanup() {
    ((this.updateDelay = -1),
      this.gamepadConnectListeners.forEach((e) => window.removeEventListener("gamepadconnected", e, !0)),
      this.gamepadDisconnectListeners.forEach((e) => window.removeEventListener("gamepaddisconnected", e, !0)),
      (this.gamepadConnectListeners = []),
      (this.gamepadDisconnectListeners = []),
      (this.gamepadButtonChangeListeners = []),
      (this.gamepadAxisChangeListeners = []));
  ...
  checkForButtonChanges(e, t) {
    ...
    for (let s = 0; s < i.length; s++) {
      ...
      (l.touched && !u.touched
        ? ((h.touchDown = !0), (c = !0))
        : !l.touched && u.touched && ((h.touchUp = !0), (c = !0)),
        l.pressed && !u.pressed
          ? ((h.pressed = !0), (c = !0))
          : !l.pressed && u.pressed && ((h.released = !0), (c = !0)),
        m.fireWhileHolding && l.pressed && u.pressed && ((h.heldDown = !0), (c = !0)),
        l.value != u.value && ((h.valueChanged = !0), (c = !0)),
        c ? ((o = !0), (d[s] = h)) : (d[s] = !1));
    }
...
function Z(a) {
  if (a instanceof SVGGraphicsElement) {
    a.getAttribute("transform") &&
      console.warn(
        "VirtualGamepadLib: Setting Transform origin on an element that already has a transform attribute. This may break the transform!",
        a
      );
    const e = a.getBBox();
    ...
    console.warn(
      "VirtualGamepadLib: Setting Transform origin on an element that is not an SVG element. This may break the transform!",
      a
    );
...
const H = 18,
  ...
  E = class E {
    constructor(e) {
      ...
      p(this, "buttonPressThreshold", 0.1);
      ...
      if (((this.buttonPressThreshold = e || this.buttonPressThreshold), E.instanceRunning))
    ...
    AddEmulatedGamepad(e, t, i = H, n = X) {
      ...
      ((this.emulatedGamepads[e] = r),
        (this.emulatedGamepadsMetadata[e] = {
          overlayMode: t
        }));
    ...
    PressButton(e, t, i, n) {
      var s, c, l;
      if (this.emulatedGamepads[e] == null)
        throw new Error(
          "Error: PressButton() - no emulated gamepad at index " +
            e +
      ...
      if (Array.isArray(t)) {
        ...
        for (var o = 0; o < t.length; o++) {
          ...
          if (m < 0 || m >= this.emulatedGamepads[e].buttons.length) {
            console.error(
              "Error: PressButton() - button index " +
                m +
                " out of range, pass a valid index between 0 and " +
                (this.emulatedGamepads[e].buttons.length - 1)
            );
            continue;
          }
          r[m] = {
    ...
    MoveAxis(e, t, i) {
      ...
      if (this.emulatedGamepads[e] == null)
        throw new Error(
          "Error: MoveAxis() - no emulated gamepad at index " +
            e +
            ", pass a valid index, or call AddEmulatedGamepad() first to create an emulated gamepad at that index"
        );
      const n = [...(((r = this.emulatedGamepads[e]) == null ? void 0 : r.axes) || [])];
      ((n[t] = i),
        Object.defineProperty(this.emulatedGamepads[e], "axes", {
          value: n,
          enumerable: !0,
          configurable: !0
        }));
    ...
    AddButtonTouchEventListeners(e, t) {
      var r;
      if (!this.emulatedGamepads[e])
        throw new Error(
          "Error: AddJoystickTouchEventListeners() - no emulated gamepad at index " +
            e +
            ", pass a valid index, or call AddEmulatedGamepad() first to create an emulated gamepad at that index"
        );
      let i = [];
      for (var n = 0; n < t.length; n++) {
        ...
        if (!s) {
          console.warn(
            "GamepadEmulator: No tap target in gamepad " + e + " display config for button " + o + ", skipping..."
          );
          continue;
        }
        const c = (h) => {
        ...
        if ((s.addEventListener("pointercancel", m), d.type == x.onOff)) {
          const h = (v) => {
            (v.preventDefault(),
              this.PressButton(e, o, 1, !0),
              d.lockTargetWhilePressed ? s.setPointerCapture(v.pointerId) : s.releasePointerCapture(v.pointerId));
          };
          s.addEventListener("pointerdown", h);
          const g = () => {
            this.PressButton(e, o, 0);
          };
          (s.addEventListener("pointerup", g),
            i.push(function () {
              (window.removeEventListener("touchstart", c),
                s.removeEventListener("pointerenter", l),
                s.removeEventListener("pointerleave", u),
                s.removeEventListener("pointerdown", h),
                s.removeEventListener("pointerup", g),
                s.removeEventListener("pointercancel", m));
            }));
        } else if (d.type == x.variable) {
          const h = this.AddDragControlListener(d, (g, v, b) => {
            let f = g ? this.buttonPressThreshold + 1e-5 : 0;
            ((f += d.directions[w.left] || d.directions[w.right] ? Math.abs(v) : 0),
              (f += d.directions[w.up] || d.directions[w.down] ? Math.abs(b) : 0),
              this.PressButton(e, o, Math.min(f, 1)));
          });
          i.push(function () {
            (window.removeEventListener("touchstart", c),
              s.removeEventListener("pointerenter", l),
    ...
    AddJoystickTouchEventListeners(e, t) {
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        if (r.tapTarget == null) {
          console.warn(
            "GamepadEmulator: No tap target in gamepad " + e + " display config for joystick " + n + ", skipping..."
          );
          continue;
        }
        const d = this.AddDragControlListener(r, (o, s, c) => {
          (r.xAxisIndex !== void 0 && this.MoveAxis(e, r.xAxisIndex, s),
            r.yAxisIndex !== void 0 && this.MoveAxis(e, r.yAxisIndex, c));
        });
        i.push(d);
      }
    ...
    ClearButtonTouchEventListeners(e) {
      var t;
      this.emulatedGamepadsMetadata[e] &&
        (t = this.emulatedGamepadsMetadata[e]) != null &&
        t.removeButtonListenersFunc &&
        this.emulatedGamepadsMetadata[e].removeButtonListenersFunc();
    }
    ...
    AddDragControlListener(e, t) {
      ...
      const r = (s) => {
          ...
          if (n === c) {
            ...
            let { x: b, y: f } = M(g, v, e.dragDistance);
            ((b = Math.max(Math.min(b, u), l)), (f = Math.max(Math.min(f, h), m)), t(!0, b, f));
          }
        },
        d = (s) => {
          n == s.pointerId &&
            (document.removeEventListener("pointermove", r, !1),
            document.removeEventListener("pointerup", d, !1),
            (n = -1),
            t(!1, 0, 0));
        };
      e.tapTarget.addEventListener("pointerdown", (s) => {
        (s.preventDefault(),
          ...
          (i.startY = s.clientY),
          (n = s.pointerId),
          e.lockTargetWhilePressed
            ? e.tapTarget.setPointerCapture(s.pointerId)
            : e.tapTarget.releasePointerCapture(s.pointerId),
          t(!0, 0, 0),
          document.addEventListener("pointermove", r, !1),
          document.addEventListener("pointerup", d, !1));
      });
      const o = (s) => {
    ...
    monkeyPatchGamepadEvents() {
      let e, t, i, n;
      (window.hasOwnProperty("ongamepadconnected") &&
        ((e = Object.getOwnPropertyDescriptor(window, "ongamepadconnected")),
        (e.configurable = !0),
        (i = window.ongamepadconnected),
        ...
        window.hasOwnProperty("ongamepaddisconnected") &&
          ((t = Object.getOwnPropertyDescriptor(window, "ongamepaddisconnected")),
          (t.configurable = !0),
          (n = window.ongamepaddisconnected),
      ...
      const r = (o) => {
        ...
        if (s && s.emulation === void 0) {
          ...
          ((this.realGpadToPatchedIndexMap[l] = u),
            (this.patchedGpadToRealIndexMap[u] = l),
      ...
      const d = (o) => {
        ...
        if (s && s.emulation === void 0) {
          ...
          (Object.defineProperty(c, "index", {
            ...
            delete this.realGpadToPatchedIndexMap[c.index],
            delete this.patchedGpadToRealIndexMap[l]);
      ...
      return (
        ...
        function () {
          (window.removeEventListener("gamepadconnected", r),
            window.hasOwnProperty("ongamepadconnected") &&
              (Object.defineProperty(window, "ongamepadconnected", e), (window.ongamepadconnected = i)),
          ...
          value: function () {
            ...
            for (let l = 0; l < i.length; l++) {
              ...
              if (m && u) {
                ...
                let h = Math.max(
                    (o = (d = u == null ? void 0 : u.buttons) == null ? void 0 : d.length) != null ? o : 0,
                    m.buttons.length
                  ),
                  g = new Array(h);
                for (let f = 0; f < h; f++) {
                ...
                m &&
                  (Object.defineProperty(m, "emulation", {
                    value: L.emulated,
                    enumerable: !0,
                    configurable: !0
                  }),
